...
import { Damage, Logger } from '@friday/ranvier';
import Parser from '../../bundle-example-lib/lib/ArgParser';
import CombatErrors from './CombatErrors';
...
export class Combat {
    ...
    static calculateWeaponDamage(attacker, average = false) {
        ...
        if (average) {
            ...
            amount = randomIntegerBetween(weaponDamage.min, weaponDamage.max);
        }
