...
import { Broadcast, Heal } from '@friday/ranvier';
...
export const listeners = {
    hit: (state) => function (damage, target, finalAmount) {
        ...
        if (sample([0, 1])) {
            ...
            Broadcast.sayAt(
                damage.attacker,
                `<b><white>The Blade of Ranvier shines with a bright white light and you see wisps of ${target.name}'s soul flow into the blade.</white></b>`,
                80
            );
