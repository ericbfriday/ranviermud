        ...
        connection.on('data', (databuf) => {
            ...
            for (let i = 0; i < inputlen; i++) {
                if (databuf[i] !== 10 && databuf[i] !== 13) { // neither LF nor CR
                    ...
                    if (
                        i + 1 < inputlen && (databuf[i + 1] === 10 || databuf[i + 1 === 13]) &&
...
const _TelnetSocket = TelnetSocket;
export { _TelnetSocket as TelnetSocket };
...
const _TelnetServer = TelnetServer;
export { _TelnetServer as TelnetServer };
