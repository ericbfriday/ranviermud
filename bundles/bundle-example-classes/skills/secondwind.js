...
import { SkillFlag, SkillType } from '@friday/ranvier';
...
export default {
    ...
    info: function (player) {
        return `Once every ${interval / 60
            } minutes, when dropping below ${threshold} energy, restore ${restorePercent}% of your max energy.`;
    },
};
